...
import 'package:nova_ai/Components/my_topic_tab.dart';
import 'package:nova_ai/Components/own_topic.dart';
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Center(child: Text('Select a Topic')),
        ),
                ...
                delegate: SliverChildBuilderDelegate((context, index) {
                  ...
                  return MyTopicTab(
                    ...
                    onTap: () async {
                      ...
                      // 🟢 Create a session with "default" type
